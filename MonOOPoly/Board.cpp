...
Board::Board() {
    ...
    board.push_back(new Property("Mediterranean Avenue", 60, 50, 50, 2, PropertyColor::Brown));

    // 2 - Community Chest (Card Field)
    board.push_back(new CardField());

    // 3 - Baltic Avenue (Brown)
    board.push_back(new Property("Baltic Avenue", 60, 50, 50, 4, PropertyColor::Brown));
    ...
    board.push_back(new Property("Oriental Avenue", 100, 50, 50, 6, PropertyColor::LightBlue));

    // 7 - Chance (Card Field)
    board.push_back(new CardField());

    // 8 - Vermont Avenue (Light Blue)
    board.push_back(new Property("Vermont Avenue", 100, 50, 50, 6, PropertyColor::LightBlue));

    // 9 - Connecticut Avenue (Light Blue)
    board.push_back(new Property("Connecticut Avenue", 120, 50, 50, 8, PropertyColor::LightBlue));
    ...
    board.push_back(new Property("Virginia Avenue", 160, 100, 100, 12, PropertyColor::Pink));
    ...
    board.push_back(new Property("St. James Place", 180, 100, 100, 14, PropertyColor::Orange));

    // 17 - Community Chest (Card Field)
    board.push_back(new CardField());

    // 18 - Tennessee Avenue (Orange)
    board.push_back(new Property("Tennessee Avenue", 180, 100, 100, 14, PropertyColor::Orange));

    // 19 - New York Avenue (Orange)
    board.push_back(new Property("New York Avenue", 200, 100, 100, 16, PropertyColor::Orange));
    ...
    board.push_back(new Property("Kentucky Avenue", 220, 150, 150, 18, PropertyColor::Red));

    // 22 - Chance (Card Field)
    board.push_back(new CardField());

    // 23 - Indiana Avenue (Red)
    board.push_back(new Property("Indiana Avenue", 220, 150, 150, 18, PropertyColor::Red));

    // 24 - Illinois Avenue (Red)
    board.push_back(new Property("Illinois Avenue", 240, 150, 150, 20, PropertyColor::Red));
    ...
    board.push_back(new Property("Atlantic Avenue", 260, 150, 150, 22, PropertyColor::Yellow));
    ...
    board.push_back(new Property("Pacific Avenue", 300, 200, 200, 26, PropertyColor::Green));

    // 32 - North Carolina Avenue (Green)
    board.push_back(new Property("North Carolina Avenue", 300, 200, 200, 26, PropertyColor::Green));

    // 33 - Community Chest (Card Field)
    board.push_back(new CardField());

    // 34 - Pennsylvania Avenue (Green)
    board.push_back(new Property("Pennsylvania Avenue", 320, 200, 200, 28, PropertyColor::Green));
    ...
    // 37 - Park Place (Blue)
    board.push_back(new Property("Park Place", 350, 200, 200, 35, PropertyColor::Blue));

    // 38 - Luxury Tax (Special Field)
    board.push_back(new SpecialField(SpecialField::Type::LUXURY_TAX, "Luxury Tax", 100));

    // 39 - Boardwalk (Blue)
    board.push_back(new Property("Boardwalk", 400, 200, 200, 50, PropertyColor::Blue));
