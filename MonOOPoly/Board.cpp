...
Board::Board()
{
    ...
    board.push_back(new Property(60, 50, 50, 2, "Brown"));

    // 2 - Community Chest
    board.push_back(new CardField());

    // 3 - Baltic Avenue (Brown)
    board.push_back(new Property(60, 50, 50, 4, "Brown"));

    // 4 - Income Tax
    board.push_back(new SpecialField(SpecialField::Type::INCOME_TAX, "Income Tax", 200));

    // 5 - Reading Railroad
    board.push_back(new SpecialField(SpecialField::Type::RAILROAD, "Reading Railroad", 200));

    // 6 - Oriental Avenue (Light Blue)
    board.push_back(new Property(100, 50, 50, 6, "Light Blue"));
    ...
    board.push_back(new Property(120, 50, 50, 8, "Light Blue"));

    // 10 - Jail/Just Visiting
    board.push_back(new SpecialField(SpecialField::Type::JAIL, "Jail"));

    // 11 - St. Charles Place (Pink)
    board.push_back(new Property(140, 100, 100, 10, "Pink"));

    // 12 - Electric Company
    board.push_back(new SpecialField(SpecialField::Type::UTILITY, "Electric Company", 150));

    // 13 - States Avenue (Pink)
    board.push_back(new Property(140, 100, 100, 10, "Pink"));

    // 14 - Virginia Avenue (Pink)
    board.push_back(new Property(160, 100, 100, 12, "Pink"));

    // 15 - Pennsylvania Railroad
    board.push_back(new SpecialField(SpecialField::Type::RAILROAD, "Pennsylvania Railroad", 200));

    // 16 - St. James Place (Orange)
    board.push_back(new Property(180, 100, 100, 14, "Orange"));
    ...
    board.push_back(new Property(240, 150, 150, 20, "Red"));

    // 25 - B. & O. Railroad
    board.push_back(new SpecialField(SpecialField::Type::RAILROAD, "B. & O. Railroad", 200));

    // 26 - Atlantic Avenue (Yellow)
    board.push_back(new Property(260, 150, 150, 22, "Yellow"));

    // 27 - Ventnor Avenue (Yellow)
    board.push_back(new Property(260, 150, 150, 22, "Yellow"));

    // 28 - Water Works
    board.push_back(new SpecialField(SpecialField::Type::UTILITY, "Water Works", 150));

    // 29 - Marvin Gardens (Yellow)
    board.push_back(new Property(280, 150, 150, 24, "Yellow"));

    // 30 - Go To Jail
    board.push_back(new SpecialField(SpecialField::Type::GO_TO_JAIL, "Go To Jail"));

    // 31 - Pacific Avenue (Green)
    board.push_back(new Property(300, 200, 200, 26, "Green"));
    ...
    board.push_back(new Property(320, 200, 200, 28, "Green"));

    // 35 - Short Line
    board.push_back(new SpecialField(SpecialField::Type::RAILROAD, "Short Line", 200));

    // 36 - Chance
    board.push_back(new CardField());

    // 37 - Park Place (Blue)
    board.push_back(new Property(350, 200, 200, 35, "Blue"));

    // 38 - Luxury Tax
    board.push_back(new SpecialField(SpecialField::Type::LUXURY_TAX, "Luxury Tax", 100));

    // 39 - Boardwalk (Blue)
    board.push_back(new Property(400, 200, 200, 50, "Blue"));
...
Vector<Property*> Board::getPropertiesByColor(const MyString& color) const
{
